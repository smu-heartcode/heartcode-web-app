...
const Home = () => {
  ...
  return (
    <Layout pageTitle="Home">
      <Hero />
      <Carousel />
      <div className="px-2 xl:px-28 py-8 mt-20 bg-gray-100">
            ...
            <Tab.List className="flex p-1 max-w-3xl mx-auto space-x-1 bg-pink-100 rounded-xl">
              {Object.keys(categories).map((category) => (
                <Tab
                  ...
                  className={({ selected }) =>
                    classNames(
                      "w-full py-2.5 text-sm lg:text-xl leading-5 text-pink-500 rounded-lg",
              ...
              {Object.values(categories).map((posts, idx) => (
                <Tab.Panel key={idx} className={classNames("p-3")}>
                  {posts.map((post, i) => (
                    <div
                      key={i}
                      className="py-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-2xl md:px-24 lg:px-8 lg:py-20"
                    >
                      <Icon
